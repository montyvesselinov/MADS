...
configure_file(${TPL_CMAKE_TEMPLATE_DIR}/configure-command.cmake.in ${GLIB2_prefix_dir}/glib2-configure-command.cmake @ONLY)
set(GLIB2_CONFIGURE_COMMAND ${CMAKE_COMMAND} -P ${GLIB2_prefix_dir}/glib2-configure-command.cmake)
configure_file(${TPL_CMAKE_TEMPLATE_DIR}/build-command.cmake.in ${GLIB2_prefix_dir}/glib2-build-command.cmake @ONLY)
set(GLIB2_BUILD_COMMAND ${CMAKE_COMMAND} -P ${GLIB2_prefix_dir}/glib2-build-command.cmake)     
configure_file(${TPL_CMAKE_TEMPLATE_DIR}/install-command.cmake.in ${GLIB2_prefix_dir}/glib2-install-command.cmake @ONLY)
set(GLIB2_INSTALL_COMMAND ${CMAKE_COMMAND} -P ${GLIB2_prefix_dir}/glib2-install-command.cmake)     
