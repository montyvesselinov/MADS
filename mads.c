...
int main( int argn, char *argv[] )
{
	...
	if( argn < 2 )
	{
		...
		printf( "\nbuild-in test problems for optimization / uncertainty-quantification techniques:\n" );
		printf( "   test=[integer]     - test problem ID [default=0]:\n" );
		printf( "                           0: Parabola (Sphere) [local and global methods]\n" );
		printf( "                           1: De Jong's Function #4\n" );
		printf( "                           2: Griewank [local and global methods]\n" );
		printf( "                           3: Rosenbrock [local and global methods]\n" );
		printf( "                           4: Step [local and global methods]\n" );
		printf( "                           6: Foxholes 2D [local and global methods]\n" );
		printf( "                           7: Polynomial fitting [local and global methods]\n" );
		printf( "                           8: Alpine function (Clerc's Function #1) [local and global methods]\n" );
		printf( "                           9: Rastrigin [local and global methods]\n" );
		printf( "                          10: Ackley [local methods only]\n" );
		printf( "                          13: 2D Tripod function [local and global methods]\n" );
		printf( "                          17: Krishna Kumar [local and global methods]\n" );
		printf( "                          18: Eason 2D [local methods only]\n" );
		...
		printf( "   mads a01 test=3 opt=tribes igrnd real=1 (global method; successful)\n" );
		printf( "   mads a01 test=3 opt=squads igrnd real=1 (coupled global/local method; successfuli & fast)\n" );
