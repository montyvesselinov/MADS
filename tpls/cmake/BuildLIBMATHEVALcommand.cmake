...
configure_file(${TPL_CMAKE_TEMPLATE_DIR}/configure-command.cmake.in ${LIBMATHEVAL_prefix_dir}/libmatheval-configure-command.cmake @ONLY)
set(LIBMATHEVAL_CONFIGURE_COMMAND ${CMAKE_COMMAND} -P ${LIBMATHEVAL_prefix_dir}/libmatheval-configure-command.cmake)
configure_file(${TPL_CMAKE_TEMPLATE_DIR}/build-command.cmake.in ${LIBMATHEVAL_prefix_dir}/libmatheval-build-command.cmake @ONLY)
set(LIBMATHEVAL_BUILD_COMMAND ${CMAKE_COMMAND} -P ${LIBMATHEVAL_prefix_dir}/libmatheval-build-command.cmake)     
configure_file(${TPL_CMAKE_TEMPLATE_DIR}/install-command.cmake.in ${LIBMATHEVAL_prefix_dir}/libmatheval-install-command.cmake @ONLY)
set(LIBMATHEVAL_INSTALL_COMMAND ${CMAKE_COMMAND} -P ${LIBMATHEVAL_prefix_dir}/libmatheval-build-command.cmake)     
