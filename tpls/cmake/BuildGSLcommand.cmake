...
configure_file(${TPL_CMAKE_TEMPLATE_DIR}/configure-command.cmake.in ${GSL_prefix_dir}/gsl-configure-command.cmake @ONLY)
set(GSL_CONFIGURE_COMMAND ${CMAKE_COMMAND} -P ${GSL_prefix_dir}/gsl-configure-command.cmake)
configure_file(${TPL_CMAKE_TEMPLATE_DIR}/build-command.cmake.in ${GSL_prefix_dir}/gsl-build-command.cmake @ONLY)
set(GSL_BUILD_COMMAND ${CMAKE_COMMAND} -P ${GSL_prefix_dir}/gsl-build-command.cmake)     
configure_file(${TPL_CMAKE_TEMPLATE_DIR}/install-command.cmake.in ${GSL_prefix_dir}/gsl-install-command.cmake @ONLY)
set(GSL_INSTALL_COMMAND ${CMAKE_COMMAND} -P ${GSL_prefix_dir}/gsl-install-command.cmake)     
