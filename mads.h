...
#define NUM_ANAL_PARAMS_AQUIFER 16
enum AQUIFER_PARAM_TAGS { POROSITY = NUM_ANAL_PARAMS_SOURCE, RF, LAMBDA, FLOW_ANGLE, VX, VY, VZ, AX, AY, AZ, TSCALE_DISP, TSCALE_ADV, TSCALE_REACT, ALPHA, BETA, NLC0 };
