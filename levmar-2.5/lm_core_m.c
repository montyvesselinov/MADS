                      ...
                      */
{
	...
	if( op->cd->ldebug )
	{
		if( op->cd->lm_acc ) printf( "LM acceleration\n" );
		else printf( "Without LM acceleration\n" );
		if( op->cd->lm_indir ) printf( "LM indirect computation of lambda changes\n" );
		else printf( "LM direct computation of lambda changes\n" );
	}
