...
int set_test_problems( struct opt_data *op )
{
	...
	switch( cd->test_func )
	{
		...
		case 9: // 2D Tripod function (Louis Gacogne) Search [-100, 100] min 0 on (0  -50)
			...
			break;
		case 10: // ShekelÕs Foxholes 2D (alternative)
			printf( "ShekelÕs Foxholes 2D (alternative)" );
			od->nObs = 30;
			break;
		case 11: // ShekelÕs Foxholes 5D (alternative)
			printf( "ShekelÕs Foxholes 10D" );
			od->nObs = 30;
			break;
		case 12: // ShekelÕs Foxholes 10D (alternative)
			printf( "ShekelÕs Foxholes 10D" );
			od->nObs = 30;
			break;
		case 20: // Foxholes 2D
			printf( "ShekelÕs Foxholes 2D" );
...
double test_problems( int D, int function, double *x, int nObs, double *o )
{
	...
	static int a1[2][25] = { { -32, -16,   0,  16,  32, -32, -16,   0,  16,  32, -32, -16,   0, 16, 32, -32, -16,   0, 16, 32, -32, -16,   0, 16, 32 },
							{ -32, -32, -32, -32, -32, -16, -16, -16, -16, -16,  16,  16,  16, 16, 16,  32,  32,  32, 32, 32,   0,   0,   0,  0,  0 } }; // For ShekelÕs Foxholes problem 2D (standard and alternative)
	...
	{4.138, 2.562, 2.532, 9.661, 5.611, 5.500, 6.886, 2.341, 9.699, 6.500}}; // For ShekelÕs Foxholes 5D and 10D problem
	...
	0.964, 0.789, 0.360, 0.369, 0.992, 0.332, 0.817, 0.632, 0.883, 0.608, 0.326 }; // For ShekelÕs Foxholes 5D and 10D problem
